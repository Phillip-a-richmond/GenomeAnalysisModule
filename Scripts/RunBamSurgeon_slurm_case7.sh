...
# Define variables
OUTBAM=/mnt/common/WASSERMAN_SOFTWARE/bamsurgeon/Case7_father.bam
OUTBAM_SORTED=/mnt/common/WASSERMAN_SOFTWARE/bamsurgeon/Case7_father.sorted.bam
OUTFQ1=/mnt/common/WASSERMAN_SOFTWARE/bamsurgeon/Case7_father_R1.fastq
OUTFQ2=/mnt/common/WASSERMAN_SOFTWARE/bamsurgeon/Case7_father_R2.fastq
INBAM=/mnt/common/OPEN_DATA/POLARIS_PROCESS/ERR1955499_GRCh38.sorted.bam
INVCFGZ=${GENEBREAKER}/TrainingScenarios/EP300_GRCh38_AutosomalDominantPaternal_Female/father_PathoVar.vcf.gz
INVCF=${GENEBREAKER}/TrainingScenarios/EP300_GRCh38_AutosomalDominantPaternal_Female/father_PathoVar.vcf
VARFILE=Case7_father_bamsurgeon_varfile.tsv
...
# Define variables
OUTBAM=/mnt/common/WASSERMAN_SOFTWARE/bamsurgeon/Case7_proband.bam
OUTBAM_SORTED=/mnt/common/WASSERMAN_SOFTWARE/bamsurgeon/Case7_proband.sorted.bam
OUTFQ1=/mnt/common/WASSERMAN_SOFTWARE/bamsurgeon/Case7_proband_R1.fastq
OUTFQ2=/mnt/common/WASSERMAN_SOFTWARE/bamsurgeon/Case7_proband_R2.fastq
INBAM=/mnt/common/OPEN_DATA/POLARIS_PROCESS/ERR2304565_GRCh38.sorted.bam
INVCFGZ=${GENEBREAKER}/TrainingScenarios/EP300_GRCh38_AutosomalDominantPaternal_Female/proband_PathoVar.vcf.gz
INVCF=${GENEBREAKER}/TrainingScenarios/EP300_GRCh38_AutosomalDominantPaternal_Female/proband_PathoVar.vcf
VARFILE=Case7_proband_bamsurgeon_varfile.tsv
