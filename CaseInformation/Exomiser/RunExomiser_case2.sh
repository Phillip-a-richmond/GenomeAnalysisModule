...
CONFIG_YML=/mnt/scratch/Public/TRAINING/GenomeAnalysisModule/CaseInformation/Exomiser/Case2_Exomiser.yml

cd /mnt/scratch/Public/TRAINING/GenomeAnalysisModule/CaseInformation/Exomiser/
mkdir -p /mnt/scratch/Public/TRAINING/GenomeAnalysisModule/CaseInformation/Exomiser/Case2/
cd /mnt/scratch/Public/TRAINING/GenomeAnalysisModule/CaseInformation/Exomiser/Case2/
