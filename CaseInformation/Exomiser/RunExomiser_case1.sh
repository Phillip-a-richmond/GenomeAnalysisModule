...
CONFIG_YML=/mnt/scratch/Public/TRAINING/GenomeAnalysisModule/CaseInformation/Exomiser/Case1_Exomiser.yml

cd /mnt/scratch/Public/TRAINING/GenomeAnalysisModule/CaseInformation/Exomiser/
mkdir -p /mnt/scratch/Public/TRAINING/GenomeAnalysisModule/CaseInformation/Exomiser/Case1/
cd /mnt/scratch/Public/TRAINING/GenomeAnalysisModule/CaseInformation/Exomiser/Case1/
