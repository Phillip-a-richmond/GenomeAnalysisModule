...
CONFIG_YML=/mnt/scratch/Public/TRAINING/GenomeAnalysisModule/CaseInformation/Exomiser/Case6_Exomiser.yml

cd /mnt/scratch/Public/TRAINING/GenomeAnalysisModule/CaseInformation/Exomiser/
mkdir -p /mnt/scratch/Public/TRAINING/GenomeAnalysisModule/CaseInformation/Exomiser/Case6/
cd /mnt/scratch/Public/TRAINING/GenomeAnalysisModule/CaseInformation/Exomiser/Case6/
