...
CONFIG_YML=/mnt/scratch/Public/TRAINING/GenomeAnalysisModule/CaseInformation/Exomiser/Case10_Exomiser.yml

cd /mnt/scratch/Public/TRAINING/GenomeAnalysisModule/CaseInformation/Exomiser/
mkdir -p /mnt/scratch/Public/TRAINING/GenomeAnalysisModule/CaseInformation/Exomiser/Case10/
cd /mnt/scratch/Public/TRAINING/GenomeAnalysisModule/CaseInformation/Exomiser/Case10/
