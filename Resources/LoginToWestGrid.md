Throughout the course we will be using WestGrid for our computational needs.  This gives us access to much more computational power than if we were to use only our local macines.
